...
export class TecsafeApi {
  ...
  public createCartWidget(el: HTMLElement): CartWidget {
    return this.createWidget(new CartWidget(this.config, el, this)) as CartWidget;
  }
  ...
  public createProductDetailWidget(el: HTMLElement): ProductDetailWidget {
    return this.createWidget(new ProductDetailWidget(this.config, el, this)) as ProductDetailWidget;
  }
